# Exact Finite-Assurance Validation Protocol
...
This protocol tests the convention-sensitive identities used by the
all-order proof.  It is finite assurance, not an enumerative proof of an
all-order theorem.  The producer and independent validator use no stored MDS
...
SHA-256 1cefda36038cac5d74c9cc18f85bd6461c1e5aede7f06d95fcef1cc4df20e39d
```
...
A PASS certifies only the frozen convention map through `k=12`.  The
all-order theorem remains deductive and proof-based.  No novelty, priority,
public-release, complexity, or larger-alphabet even claim follows from this
protocol.
