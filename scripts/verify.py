...
EXPECTED_PDF = "f6098eefed30248e3dd11eb73b63d32519d68af4cdb4f9349e762cfd440da8cc"
EXPECTED_INPUTS = {
    "THEOREM_DERIVATION.md": "1cefda36038cac5d74c9cc18f85bd6461c1e5aede7f06d95fcef1cc4df20e39d",
    "VALIDATION_PROTOCOL.md": "67ef1020f7364e25e96519f8247b8cd01f955e6c50ec2133733c0a52bb1705e6",
}
EXPECTED_ROWS = [
    [2, 3, 0, 0, 0, 0, 0],
    [4, 6, 3, 1, 1, 2, 1],
...
def main() -> int:
    ...
    result = {
        ...
        "claim_boundary": "FINITE_CONVENTION_ASSURANCE_ONLY_ALL_ORDER_THEOREM_IS_PROOF_ONLY",
        "checks": checks,
